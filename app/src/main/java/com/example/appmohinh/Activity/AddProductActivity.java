...
public class AddProductActivity extends AppCompatActivity {
    ...
    private SpinnerTypeAdapter spinnerTypeFoodAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataTypeFood.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                Type typeFood1 = snapshot.getValue(Type.class);
                if (typeFood1 != null) {
        ...
        spinnerTypeFoodAdapter = new SpinnerTypeAdapter(this, listTypeFood);
