        ...
        mRefTypeFood.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    TypeFood objTypeFood = dataSnapshot.getValue(TypeFood.class);
                    if (objTypeFood != null) {
                        listTypeFood.add(objTypeFood);
                    }
                }
                adapter = new SpinnerTypeFoodAdapter(getApplicationContext(), listTypeFood);
