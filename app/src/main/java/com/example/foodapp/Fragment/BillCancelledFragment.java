 ...
 * Use the {@link BillCancelledFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BillCancelledFragment extends Fragment {

    private RecyclerView recy_billCancelled;
    private List<Bill> listBill, listBillAdmin;
    private BillAdminAdapter adapter, adapterAdmin;
    private String idUser;

    public BillCancelledFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static BillCancelledFragment newInstance() {
        BillCancelledFragment fragment = new BillCancelledFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recy_billCancelled = view.findViewById(R.id.recy_billCancelled);
        ...
        mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                Bill objBill = snapshot.getValue(Bill.class);
                if (objBill != null && objBill.getStatus() == 5 && objBill.getIdUser().equals(idUser)) {
        ...
        if (email.equals("admin@gmail.com")) {
            recy_billCancelled.setAdapter(adapterAdmin);
        } else {
            recy_billCancelled.setAdapter(adapter);
        }
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL);
        recy_billCancelled.addItemDecoration(dividerItemDecoration);
        recy_billCancelled.setLayoutManager(linearLayoutManager);
    }
